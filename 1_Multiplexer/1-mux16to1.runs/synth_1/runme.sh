...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/1-mux16to1/1-mux16to1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rete_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rete_on_board.tcl
