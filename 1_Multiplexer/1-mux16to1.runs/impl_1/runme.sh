...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/1-mux16to1/1-mux16to1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rete_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rete_on_board.tcl -notrace
