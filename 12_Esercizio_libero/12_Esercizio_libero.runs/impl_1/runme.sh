...
HD_PWD='C:/Users/biagi/Desktop/12_Esercizio_libero/12_Esercizio_libero.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_on_board.tcl -notrace
