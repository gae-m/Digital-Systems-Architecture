...
HD_PWD='C:/Users/biagi/Desktop/12_Esercizio_libero/12_Esercizio_libero.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_on_board.tcl
