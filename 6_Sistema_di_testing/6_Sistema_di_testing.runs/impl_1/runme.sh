...
HD_PWD='C:/Users/biagi/6_Sistema_di_testing/6_Sistema_di_testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_di_testing_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_di_testing_on_board.tcl -notrace
