...
HD_PWD='C:/Users/biagi/6_Sistema_di_testing/6_Sistema_di_testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_di_testing_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_di_testing_on_board.tcl
