...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/11_Moltiplicatore_di_Booth/11_Moltiplicatore_di_Booth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sys_on_board.tcl -notrace
