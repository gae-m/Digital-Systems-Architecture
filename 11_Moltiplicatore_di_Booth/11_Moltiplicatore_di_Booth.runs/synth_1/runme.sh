...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/11_Moltiplicatore_di_Booth/11_Moltiplicatore_di_Booth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_on_board.tcl
