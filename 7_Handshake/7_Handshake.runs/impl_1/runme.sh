...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/7_Handshake/7_Handshake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log handshake_system_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source handshake_system_on_board.tcl -notrace
