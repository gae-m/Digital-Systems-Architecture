...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/7_Handshake/7_Handshake.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log handshake_system_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source handshake_system_on_board.tcl
