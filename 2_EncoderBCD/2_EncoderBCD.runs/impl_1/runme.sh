...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/2_EncoderBCD/2_EncoderBCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoderBCD_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoderBCD_on_board.tcl -notrace
