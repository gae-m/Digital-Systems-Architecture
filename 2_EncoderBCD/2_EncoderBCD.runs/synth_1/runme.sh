...
HD_PWD='C:/Users/Donato/Desktop/vivado_projects/2_EncoderBCD/2_EncoderBCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoderBCD_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoderBCD_on_board.tcl
