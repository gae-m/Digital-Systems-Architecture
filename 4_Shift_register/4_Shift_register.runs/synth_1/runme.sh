...
HD_PWD='C:/Users/biagi/4_Shift_register/4_Shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register_strutturale.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_register_strutturale.tcl
